                ...
                children: [
                  CircleAvatar(
                    ...
                    backgroundImage: state.userAvatarPath != null
                        ...
                        : (File(state.userAvatarPath!).existsSync()
                        ? FileImage(File(state.userAvatarPath!)) as ImageProvider
                        : null))
                        : null,
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  /// Appelé par le carousel promo pour scroller vers la liste produits
  ...
  Widget _buildPromoBanner(bool isDark) => _PromoBannerCarousel(
    onTap: () {
      Navigator.push(
        context,
...
class _PromoBannerCarousel extends StatefulWidget {
  ...
  const _PromoBannerCarousel({this.onTap});
...
class _PromoBannerCarouselState extends State<_PromoBannerCarousel> {
  ...
  static const List<Map<String, String>> _promos = [
    {
      'title': 'HEY, ACHETEZ PLUS',
      'subtitle': 'EN DÉPENSANT MOINS',
      'body': 'Effectuez vos cotisations, patientez, et recevez chaque mois du crédit shopping gratuit sur glotelho.cm',
    },
    {
      'title': "JUSQU'À 5% DE BONUS",
      'subtitle': 'GRATUIT CHAQUE MOIS',
      'body': 'Effectuez vos cotisations, patientez, et recevez chaque mois du crédit shopping gratuit sur glotelho.cm',
    },
    {
      'title': 'SUR VOS COTISATIONS',
    ...
    },
    {
      ...
      'body': 'Livraison en temps réel dans toute la ville. Suivez votre commande en direct sur la carte.',
    },
  ];
      ...
      children: [
        SizedBox(
          ...
          child: PageView.builder(
            ...
            itemBuilder: (_, i) => _buildCard(_promos[i]),
          ),
        ),
        const SizedBox(height: 6),
        // Indicateurs dots
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: const LinearGradient(
            colors: [Color(0xFF0D5C3A), Color(0xFF1A8A56)],
            begin: Alignment.topLeft,
            end: Alignment.bottomRight,
          ),
          borderRadius: BorderRadius.circular(14),
          boxShadow: [
            BoxShadow(color: const Color(0xFF0D5C3A).withOpacity(0.3),
