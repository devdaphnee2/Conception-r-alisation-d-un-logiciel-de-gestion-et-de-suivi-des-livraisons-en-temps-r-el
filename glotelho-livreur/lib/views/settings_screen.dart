...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final nom = driver != null ? '${driver.prenom} ${driver.nom}' : 'Audric Ndeugoue';
    final phone = driver?.telephone ?? '699001122';
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            // --- CARTE PROFIL NON CLIQUABLE (SANS FLÈCHE ET SANS INKWELL) ---
            Container(
              decoration: BoxDecoration(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: (isOnline ? Colors.green : Colors.amber).withOpacity(0.15),
            ...
            _buildGroupedContainer([
              ...
              _buildTileItem(
                ...
                onTap: () => _showInfoDialog(
                  'Sécurité',
                  'Pour modifier votre mot de passe, contactez l\'administrateur Glotelho.',
                ),
              ),
              _buildDivider(),
              _buildTileItem(
                ...
                onTap: () => _showInfoDialog(
                  'Moyens de retrait',
                  'Les paiements sont automatiquement virés vers votre compte Mobile Money.',
                ),
              ),
            ]),
            const SizedBox(height: 24),
