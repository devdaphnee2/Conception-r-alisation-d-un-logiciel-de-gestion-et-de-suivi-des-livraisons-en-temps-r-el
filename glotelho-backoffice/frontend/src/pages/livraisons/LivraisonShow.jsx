...
const statusConfig = {
    ...
    'Valide_':    { bg: '#c8e6c9',              color: '#1b5e20',              label: 'Validee', step: 2 },
...
export default function LivraisonShow() {
    ...
    var steps = [
        ...
        { label: 'Assignee', done: livraison && ['Assign_','Valide_','En_cours','Livr_'].includes(livraison.status) },
    ...
    return (
        <div style={{ maxWidth: '900px', fontFamily: 'Poppins, sans-serif' }}>
            ...
            {livraison && ['Assign_', 'Valide_', 'En_cours'].includes(livraison.status) && finalWaLink && (
            ...
            <div style={cardStyle}>
                ...
                <p style={{ fontSize: '11px', color: P.outline, margin: '0 0 16px 0' }}>
                    ...
                    {livraison && livraison.status === 'Valide_'    && 'Livreur en route pour recuperer le colis.'}
                ...
                <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap', marginBottom: '14px' }}>
                    ...
                    {/* Bouton Tracking GPS — vers la vue manager /tracking, PAS la page client /suivi/:id */}
                    {livraison && ['Assign_', 'Valide_', 'En_cours'].includes(livraison.status) && (
                        <Link to={'/tracking'}
